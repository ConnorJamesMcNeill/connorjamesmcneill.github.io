...
### The core challenge of fitting a Tesla Small Rear Drive Unit into a Porsche 356 is that nothing lines up. The 356 was designed around a flat-four that sat low and behind the rear axle, and the Tesla unit is a completely different shape, size, and mounting geometry. The Tesla Small Drive Unit weighs approximately 50 kg, puts out around 193 kW peak power with roughly 430 Nm peak torque at the motor shaft, and steps that through a 9.73:1 single-speed gearbox. The solution was a custom cradle structure that could bridge the two, locate the drive unit correctly relative to the axles, and transfer its loads into the original chassis pickup points without modifying the body.
